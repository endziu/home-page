...
const EthIcon = () => (
  <svg viewBox="0 0 16 16" width="16" height="16">
    <path
      fill-rule="nonzero"
      d="M7.963 11.98l-4.91-2.9L7.963 16l4.913-6.92-4.914 2.9zM8.037 0l-4.91 8.148 4.91 2.903 4.91-2.9L8.037 0z "
    />
  </svg>
)
